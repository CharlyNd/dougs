...
export function OperationItem({ operation, onPress }: OperationItemProps) {
    ...
    >
      <View className="flex-row justify-between items-center">
        <View className="flex-1">
          <Text className="text-lg font-semibold" style={{ color: Colors.labelSummary }} numberOfLines={1}>
            {operation.label}
          </Text>
          {!!operation.description && (
            <Text className="text-sm text-gray-500 italic" style={{ color: Colors.labelDescription }} numberOfLines={1}>
              {operation.description}
            </Text>
          )}
        </View>
